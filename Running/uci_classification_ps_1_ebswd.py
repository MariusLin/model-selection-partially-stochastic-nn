...
n_hidden = 1
activation_fn = "tanh"
num_iters = 5000  # Number of iteterations of Wasserstein optimization
...
def prior_optimization(dataset):
    ...
    for split_id in range(n_splits):
        ...
        gp = GPR(X=torch.from_numpy(X_train_), Y=util.to_one_hot(torch.from_numpy(y_train), num_classes).reshape([-1, 1]),
