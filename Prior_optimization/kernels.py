...
class Static(Kern):
    ...
    def __init__(self, input_dim, variance=1.0, active_dims=None, name=None):
        ...
        self.variance = PositiveParam(variance)
...
class Stationary(Kern):
    ...
    def __init__(self, input_dim, variance=1.0, lengthscales=None,
        ...
        if ARD:
            ...
            self.lengthscales = PositiveParam(lengthscales)
            self.ARD = True
        else:
            if lengthscales is None:
                lengthscales = 1.0
...
class Periodic(Stationary):
    ...
    def __init__(self, input_dim, variance=1.0, lengthscales=None,
        ...
        self.period = PositiveParam(period)
...
class ArcCosine(Kern):
    ...
    def __init__(self, input_dim,
        ...
        self.variance = PositiveParam(variance)
        self.bias_variance = PositiveParam(variance)
        self.ARD = ARD
        if ARD:
            ...
            self.weight_variances = PositiveParam(weight_variances)
        else:
            if weight_variances is None:
