...
Additionally, it performs DWF with the standard deviations
"""
...
class MapperWassersteinDWF(object):
        ...
        for it in range(1, num_iters+1):
            ...
            if omega_params:
                for layer in self.bnn.layers:
                    ...
                    num_pruned += (self.bnn.output_layer.get_W_std()==0).sum().item()
                    num_pruned += (self.bnn.output_layer.get_b_std()==0).sum().item()
