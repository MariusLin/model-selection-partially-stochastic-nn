...
from Partial_stochasticity.Layers.stoch_conv import StochConv2d
from Full_stochasticity.Layers.conv import Conv2d
from Full_stochasticity.Layers.linear import Linear

"""
This is a slight adaptation from Tran et al. 2022
The only difference is that the parameters of the first layer explicitly have the suffix stoch
"""
...
class PreResNet(nn.Module):
    def __init__(self, depth, num_classes=10, block_name='BasicBlock',
        ...
        self.inplanes = 16
        self.conv1 = StochConv2d(3, 16, kernel_size=3, padding=1,
