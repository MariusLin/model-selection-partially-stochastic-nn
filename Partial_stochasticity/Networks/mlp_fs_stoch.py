...
from Partial_stochasticity.Layers.stoch_linear import StochLinear

"""
This is a MLP where the first layer is stochastic
"""
...
class StochMLP(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_dims, activation_fn,
        ...
        self.layers = nn.ModuleList([StochLinear(
    ...
    def reset_parameters(self):
        for m in self.modules():
            if isinstance(m, Linear) or isinstance(m, StochLinear):
                m.reset_parameters()
