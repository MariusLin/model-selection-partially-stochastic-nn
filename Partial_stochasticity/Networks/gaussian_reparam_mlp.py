...
from Partial_stochasticity.Layers.gaussian_reparam_linear import GaussianLinearReparameterization
...
"""
This is an MLP where the first layer has a Gaussian prior on the parmaeters and the remaining ones are deterministic
"""
