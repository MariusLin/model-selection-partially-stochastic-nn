...
class BayesNetMasked:
    ...
    def _initialize_sampler(self, num_datapoints, params, lr=1e-2, mdecay=0.05,
        ...
        if self.sampling_method == "adaptive_sghmc":
            ...
            self.sampler = AdaptiveSGHMC(params,
                                         **self.sampler_params)
        elif self.sampling_method == "sghmc":
            self.sampler = SGHMC(params,
                                 **self.sampler_params)
    ...
    def train(self, x_train=None, y_train=None, data_loader=None,
        ...
        if not continue_training:
            ...
            self._initialize_sampler(num_datapoints,stoch_params, lr, mdecay,
